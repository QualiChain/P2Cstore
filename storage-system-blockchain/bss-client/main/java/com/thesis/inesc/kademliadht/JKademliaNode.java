...
import com.thesis.inesc.kademliadht.dht.*;
...
import com.thesis.inesc.kademliadht.message.MessageFactory;
import com.thesis.inesc.kademliadht.node.KademliaId;
import com.thesis.inesc.kademliadht.node.Node;
import com.thesis.inesc.kademliadht.operation.*;
import com.thesis.inesc.kademliadht.routing.JKademliaRoutingTable;
import com.thesis.inesc.kademliadht.routing.KademliaRoutingTable;
import com.thesis.inesc.kademliadht.util.serializer.JsonDHTSerializer;
import com.thesis.inesc.kademliadht.util.serializer.JsonRoutingTableSerializer;
 ...
 *
 */
public class JKademliaNode implements KademliaNode, Serializable
{
    ...
    public JKademliaNode(String ownerId, KademliaId defaultId, int udpPort, BigDecimal totalStorage) throws IOException
    {
        this(
                ownerId,
                new Node(defaultId, InetAddress.getLocalHost(), udpPort, totalStorage),
                udpPort,
     ...
     */
    public static JKademliaNode loadFromFile(String ownerId) throws IOException, ClassNotFoundException
    {
     ...
     * @throws ClassNotFoundException
     */
    public static JKademliaNode loadFromFile(String ownerId, KadConfiguration iconfig) throws IOException, ClassNotFoundException
    {
        DataInputStream din;
    ...
    public int delete(KadContent c) throws NoSuchElementException, IOException
    {
        DeleteOperation dop = new DeleteOperation(this.server, this, new JKademliaStorageEntry(c), this.dht, this.config, c);
        dop.execute();

        /* Return how many nodes the content was stored on */
        return dop.numNodesStoredAt();
    }

    /*public int update(GetParameter param, KadContent c) throws NoSuchElementException, IOException, ContentNotFoundException
    {
        UpdateOperation uop = new UpdateOperation(this.server, this, entry, this.dht, this.config);
        uop.execute();

        /* Return how many nodes the content was stored on
        return uop.numNodesStoredAt();
    }*/
