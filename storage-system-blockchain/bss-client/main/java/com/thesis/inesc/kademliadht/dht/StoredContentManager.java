...
class StoredContentManager
{
    ...
    public void remove(KademliaStorageEntryMetadata entry) throws ContentNotFoundException
    {
        ...
        {
            //System.out.println("This content does not exist in the Storage Entries of the local DHT");
            throw new ContentNotFoundException("This content does not exist in the Storage Entries of the local DHT");
        }
    }
