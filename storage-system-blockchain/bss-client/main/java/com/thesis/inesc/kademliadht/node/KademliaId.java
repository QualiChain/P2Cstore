...
public class KademliaId implements Streamable, Serializable
{
     ...
     */
    public KademliaId(String data) throws WrongInputException {
        keyBytes = HashFunction.fromBase58ToBytes(data);
    ...
    public String stringRepresentation()
    {
        ...
        return HashFunction.fromByteToBase58(this.keyBytes);
